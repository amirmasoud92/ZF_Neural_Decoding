######################################
## Figure 3 - Part B - Envelope Decoding - R/ Correlation - Real vs. Shuffle - Envelope 
######################################
...
null_model <- lmer('(Corr_Session_LFP - Corr_Shuffle_LFP) ~ -1 + (1 | Birds_Name)', data = df3A.event)
effect_model <- lmer('(Corr_Session_LFP - Corr_Shuffle_LFP) ~ 1 + (1 | Birds_Name)', data = df3A.event)
...
mean_diff <- mean(df3A.event$Corr_Session_LFP - df3A.event$Corr_Shuffle_LFP)
se_diff <- sd(df3A.event$Corr_Session_LFP - df3A.event$Corr_Shuffle_LFP) / sqrt(nrow(df3A.event))
...
null_model_cohen <- lmer('(Corr_Session_MUAe - Corr_Shuffle_MUAe) ~ -1 + (1 | Birds_Name)', data = df3A.event)
effect_model_cohen <- lmer('(Corr_Session_MUAe - Corr_Shuffle_MUAe) ~ 1 + (1 | Birds_Name)', data = df3A.event)
...
mean_diff_cohen <- mean(df3A.event$Corr_Session_MUAe - df3A.event$Corr_Shuffle_MUAe)
se_diff_cohen <- sd(df3A.event$Corr_Session_MUAe - df3A.event$Corr_Shuffle_MUAe) / sqrt(nrow(df3A.event))
